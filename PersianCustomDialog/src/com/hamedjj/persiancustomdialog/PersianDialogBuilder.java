...
public class PersianDialogBuilder extends AlertDialog.Builder {
	...
	public PersianDialogBuilder(Context context) {
		super(context);

		mDialogView = View.inflate(context, R.layout.persian_dialog_layout, null);
		setView(mDialogView);
         ...
         */        
        public PersianDialogBuilder setDividerColor (String colorString) {
        	mDivider.setBackgroundColor(Color.parseColor(colorString));
        	return this;
       }
        
        @Override
        public PersianDialogBuilder setTitle(CharSequence text) {
            mTitle.setText(text);
            return this;
        }
        
        @Override
        public PersianDialogBuilder setTitle(int textResId) {
            mTitle.setText(textResId);
            return this;
        }

        public PersianDialogBuilder setTitleColor(String colorString) {
        	mTitle.setTextColor(Color.parseColor(colorString));
        	return this;
        }

        @Override
        public PersianDialogBuilder setMessage(int textResId) {
            mMessage.setText(textResId);
            return this;
        }

        @Override
        public PersianDialogBuilder setMessage(CharSequence text) {
            mMessage.setText(text);
            return this;
        }

        @Override
        public PersianDialogBuilder setIcon(int drawableResId) {
            mIcon.setImageResource(drawableResId);
            return this;
        }

        @Override
        public PersianDialogBuilder setIcon(Drawable icon) {
        ...
        public PersianDialogBuilder setCustomView(int resId, Context context) {
